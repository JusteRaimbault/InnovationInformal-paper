...
% revision: todo
%  - add plots params pareto front, discuss ushape diversity - interaction proba, discuss profile algorithm application
%  X add link git and data
%  - add refs: [1] Sayama, H., & Dionne, S. D. (2015). Studying collective human decision making and creativity with evolutionary computation. Artificial Life, 21(3), 379-393. [2] Dionne, S. D., Sayama, H., & Yammarino, F. J. (2019). Diversity and social network structure in collective decision making: evolutionary perspectives with agent-based simulations. Complexity, 7591072.
%  - add to discussion: role of modularity/spatial clustering (// papers Hiroki)
%  - add to dicussion or contributions: realistic settings
%  - add key takeover: abstract, into, discussion
%  - pb of factors/assumption contributing: cf sensitivity analysis and exploration: add remark on model complexity? - fixed assumption vs params
