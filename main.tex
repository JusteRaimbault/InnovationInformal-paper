...
%  - possibly diagram describing model?
...
%  X  "1e-4" -> Is this "10^{-4}" ?
%  -  In Figure 1, the color difference between three darker lines was too subtle and they were hard to distinguish. -> fig1 redrawn with discrete colors
%  -  "It is interesting to *not* that" -> "... note ..."
%  -  "these parameter" -> "these parameters"
%  -  "... a certain size Folta et al. (2006)." -> "... a certain size (Folta et al. 2006)."
%  -  Figure 2 should be moved to before the References.
